...
std::string irc::standard_message::get_keyword() const
{
    return m_command;
}

std::string irc::standard_message::get_command() const
{
    return m_command;
}

irc::standard_message& irc::standard_message::operator=(const standard_message& other)
{
    if (this == &other)
    {
        return *this;
...
irc::standard_message& irc::standard_message::operator=(standard_message&& other)
{
    if (this == &other)
    {
        return *this;
